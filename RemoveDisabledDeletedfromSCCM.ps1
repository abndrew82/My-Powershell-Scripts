$SiteCode = "FS1"
$SiteServer = "fsusccm.uncfsu.edu"
$EmailRecipient = "asenn@uncfsu.edu"
...
function Remove-CMRecord
{
    ...
    Process
    {
        ...
        Try
        {
            $Computer = [wmi] (Get-WmiObject -ComputerName $SiteServer -Namespace "root\sms\site_$SiteCode" -Class sms_r_system -Filter "Name = `'$Computername`'").__PATH
        }
        Catch
        {
            $Result = $_
